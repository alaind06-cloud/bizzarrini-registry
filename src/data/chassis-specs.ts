...
const RAW_SPEC_FIELDS = [
  ...
  { key: "compression", label: { fr: "Taux de compression", en: "Compression ratio", it: "Rapporto di compressione" } },
  { key: "fuelSystem", label: { fr: "Alimentation", en: "Fuel system", it: "Alimentazione" } },
  { key: "torque", label: { fr: "Couple max", en: "Max torque", it: "Coppia max" } },
  { key: "transmission", label: { fr: "Transmission", en: "Transmission", it: "Trasmissione" } },
  ...
  { key: "wheels", label: { fr: "Roues / pneus", en: "Wheels / tyres", it: "Ruote / pneumatici" } },
  { key: "brakes", label: { fr: "Freins", en: "Brakes", it: "Freni" } },
  { key: "electrical", label: { fr: "Électrique", en: "Electrics", it: "Impianto elettrico" } },
  { key: "wheelbase", label: { fr: "Empattement", en: "Wheelbase", it: "Passo" } },
  { key: "track", label: { fr: "Voies", en: "Track", it: "Carreggiate" } },
  { key: "length", label: { fr: "Longueur", en: "Length", it: "Lunghezza" } },
  { key: "width", label: { fr: "Largeur", en: "Width", it: "Larghezza" } },
  { key: "height", label: { fr: "Hauteur", en: "Height", it: "Altezza" } },
  { key: "groundClearance", label: { fr: "Garde au sol", en: "Ground clearance", it: "Altezza da terra" } },
  { key: "weight", label: { fr: "Poids à vide", en: "Kerb weight", it: "Peso a vuoto" } },
  { key: "fuelTank", label: { fr: "Réservoir", en: "Fuel tank", it: "Serbatoio" } },
  { key: "topSpeed", label: { fr: "Vitesse max", en: "Top speed", it: "Velocità max" } },
