...
export const fr: Dict = {
  ...
  "auth.field.raisonLibre": "Expliquez votre motivation (quel est votre lien avec Bizzarrini ? Êtes-vous propriétaire, chercheur, passionné, etc. ?)",
  "auth.field.raisonLibrePlaceholder": "Ex : Je possède une Bizzarrini 5300 GT châssis B-0212 depuis 2015 et je cherche à documenter son historique de course.",
  "auth.err.raisonTropCourte": "Merci de détailler votre motivation ({n} caractères minimum).",
